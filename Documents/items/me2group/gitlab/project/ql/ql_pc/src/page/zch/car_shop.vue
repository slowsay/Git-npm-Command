  ...
  <div class="car_shop">
    <div class="content">
      ...
      <div class="con" v-for="(item,i) of car_sp" :key="i" :class="{'gray':item.dis==true}" >
        <div class="content_left" @click="gotoDetail">
          <div class="text_img">
            <div v-if="item.dis==true">
              <p class="disbtn">失效</p>
            </div>
            <div v-else>
              <img :src="item.no" alt class="swite" v-show="!item.show" @click.stop="radio(item)" />
              <img :src="item.yes" class="swite" v-show="item.show" @click.stop="radio(item)" />
            </div>
      ...
      car_sp: [
        {
          ...
          show: false,
          sp: require("../../assets/image/zch/car/sp.png"),
