...
export default {
  ...
  //帖子详情类
  addViewsAndMessage: baseUrl + '/ltPostInfo/addViewsAndMessage', //根据帖子id查询帖子详情
  lzlReply: baseUrl + '/ltPostInfo/lzlReply', //楼中楼回复
  onlyFloorUser: baseUrl + '/ltPostInfo/onlyFloorUser', //只看楼主
  reply: baseUrl + '/ltPostInfo/reply', //回复帖子
  replyList: baseUrl + '/ltPostInfo/replyList', //查询回复信息
